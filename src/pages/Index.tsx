...
const NEWS = [
  {
    ...
    date: "24 апреля 2026",
    category: "Официально",
    title: "Заседание Совета депутатов муниципального образования",
    excerpt: "25 апреля 2026 года состоится очередное заседание Совета депутатов. В повестке дня рассмотрение бюджетных вопросов и утверждение муниципальных программ.",
  },
  {
    id: 2,
    date: "22 апреля 2026",
    category: "Благоустройство",
    title: "Начало работ по благоустройству центральной площади",
    excerpt: "Администрация сообщает о начале работ по благоустройству центральной площади посёлка. Работы будут завершены до 1 июня 2026 года.",
  },
  {
    id: 3,
    date: "20 апреля 2026",
    category: "ЖКХ",
    title: "Плановое отключение горячего водоснабжения",
    excerpt: "В период с 28 апреля по 5 мая 2026 года в связи с проведением плановых ремонтных работ будет отключено горячее водоснабжение в домах по улицам Ленина и Советской.",
  },
  {
    id: 4,
    date: "18 апреля 2026",
...
const ANNOUNCEMENTS = [
  {
    id: 1,
    date: "25 апреля 2026",
    title: "Приём граждан Главой администрации",
    text: "Приём ведётся по вторникам с 14:00 до 17:00. Запись по телефону: 8 (800) 000-00-00",
    urgent: true,
  },
  {
    id: 2,
    date: "23 апреля 2026",
    title: "Субботник по уборке территории",
    text: "26 апреля 2026 года приглашаем всех жителей принять участие в общегородском субботнике. Сбор в 09:00 у администрации.",
    urgent: false,
  },
  {
    id: 3,
    date: "20 апреля 2026",
    title: "Изменение графика работы МФЦ",
    text: "С 1 мая 2026 года МФЦ переходит на летний режим работы: пн–пт с 8:00 до 20:00, сб с 9:00 до 18:00.",
    urgent: false,
  },
  {
    id: 4,
    date: "15 апреля 2026",
    title: "Конкурс на лучший двор — приём заявок",
    text: "До 15 мая принимаются заявки на участие в ежегодном конкурсе «Лучший двор». Подробная информация в отделе благоустройства.",
    urgent: false,
  },
];
...
const EVENTS = [
  { day: 1, month: "мая", label: "Праздник весны и труда", type: "holiday" },
  { day: 9, month: "мая", label: "День Победы", type: "holiday" },
  { day: 12, month: "мая", label: "Заседание Совета депутатов", type: "meeting" },
  { day: 15, month: "мая", label: "Завершение приёма заявок «Лучший двор»", type: "deadline" },
  { day: 24, month: "мая", label: "День кадрового работника", type: "event" },
  { day: 1, month: "июня", label: "Завершение работ на центральной площади", type: "deadline" },
  { day: 12, month: "июня", label: "День России", type: "holiday" },
];
